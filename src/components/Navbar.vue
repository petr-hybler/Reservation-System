<template lang="html">
  <div class="">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white">
      <a class="navbar-brand" href="#">vReserve</a>
        ...
        <div class="navbar-nav nav-contact">
             <div class="row mx-3">
               ...
               <div class="text-left">
                ...
                </svg> <a class="contact" href="mailto:info@vreserve.com?subject=Info">info@vreserve.com</a>
               </div>
             </div>
        </div>
      </div>
      <div class="collapse navbar-collapse w-100" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          ...
          <router-link tag="a" class="nav-link" to="/about" active-class="active" exact>About</router-link>
          <router-link tag="a" class="nav-link" to="/pricing" active-class="active" exact>Pricing</router-link>
          <router-link tag="a" class="nav-link" to="/reserve" active-class="active" exact>Reserve</router-link>
        </div>
      </div>
    </nav>
  </div>
